...
import com.salesman.adapter.viewholder.MonthYeJiListHolder;
 ...
 */
public class MonthYeJiListFragment extends BaseFragment implements OnCommonListener, SwipeRefreshLayout.OnRefreshListener, RecyclerArrayAdapter.OnMoreListener {
    private final String TAG = MonthYeJiListFragment.class.getSimpleName();
    ...
    protected void findViews(View view) {
        ...
        adapter = new RecyclerArrayAdapter<YeJiListBean.DataBean.YeJiBean>(mContext) {
            ...
            public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
                return new MonthYeJiListHolder(parent, R.layout.item_yeji_month_list);
            }
        };
