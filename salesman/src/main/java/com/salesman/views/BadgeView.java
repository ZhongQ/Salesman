...
public class BadgeView extends TextView {
    ...
    private static final int DEFAULT_MARGIN_DIP = 5;                                                            // 红点外边距
    private static final int DEFAULT_LR_PADDING_DIP = 5;                                                        // 文字左右padding
    private static final int DEFAULT_CORNER_RADIUS_DIP = 8;
    private static final int DEFAULT_POSITION = POSITION_TOP_RIGHT;
    private static final int DEFAULT_BADGE_COLOR = Color.parseColor("#ED4B1C"); //Color.RED;
    private static final int DEFAULT_TEXT_COLOR = Color.WHITE;
    private static final float DEFAULT_TEXT_SIZE = 12f;                                                         // 文字大小
